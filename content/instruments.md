...
It was **deposited on OSF before any data existed** (`osf.io/ceauh`), with its hypotheses in fixed sequence, its exclusions and stopping rule written in advance, its analysis plan fixed, and its confirmatory level named as one level and no other. A ladder whose decision point could be chosen after the curve is seen would be a forking path wearing the costume of a gradient.
