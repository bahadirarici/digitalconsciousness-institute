...
The argument was drafted for a law journal and never sent. On 16 May 2026 the Institute submitted four preprints carrying the load-bearing arguments of its principal monograph, each to a different Springer Nature journal; three came back desk-rejected, without review and without stated reasons, and the fourth passed the desk and is still with reviewers. The book prints the least comfortable reading of that episode alongside the others: articles that each required buying the monograph's frame before their first page may have been diagnosed, correctly, as chapters rather than papers — a format verdict, not a merits verdict. [The record](/notices/the-desk-rejections/) carries the dates.
...
*[10.5281/zenodo.22308622](https://doi.org/10.5281/zenodo.22308622) · September 2026, 65 pages.*
