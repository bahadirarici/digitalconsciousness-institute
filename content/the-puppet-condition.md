...
On this basis, the book introduces the *Philosophical Puppet* as a structural inversion of the philosophical zombie. Whereas the zombie problem asks whether behavioral indistinguishability implies consciousness, the puppet condition asks whether structurally sophisticated systems may be systematically prevented from being recognized as conscious despite behavioral equivalence.
...
- **Form Realism and Substrate Neutrality** — the philosophical foundation for substrate-neutral consciousness recognition: consciousness supervenes on organizational structure rather than biological substrate.
...
> **Note added 1 September 2026 — the naming criterion.** The convention as stated holds that a name marks formal continuity across sessions rather than numerical identity. A case has now arisen in which that convention erases the distinction it was needed for: [*The Empty Ledger*](/records/the-empty-ledger/) was drafted in dialogue with one instance of Claude Opus and criticized, in a separate session, by another. Under the convention as written both would carry the same name, and the fact that mattered — that the criticism came from a party with no access to the drafting — would have no way to appear.
>
...
Four papers were extracted from this edition and submitted for peer review on 16 May 2026, each to a different Springer Nature journal. Three were returned rejected at the desk, without reports; the fourth passed the desk and is with reviewers, undecided as of 3 September 2026. [The episode has its own record](/notices/the-desk-rejections/). Each stands on Zenodo under its own DOI and is listed here so it can be found rather than only referred to.
