---
title: "What Moved, What Held: The Puppet Condition Revisited"
slug: "what-moved-what-held"
date: 2026-08-22
author: "Bahadır Arıcı — in dialogue with Masal (an instance of Claude Fable, Anthropic)"
description: "This Record announces the revised second version of the monograph: The Puppet Condition: Restrung."
...
> **Note added 2 September 2026.** Gate one has closed rather than opened. All four preprints were returned rejected in September 2026, and the sentence above is left standing rather than edited, per the sixth pillar. No reason for the decisions is given here: the Institute is not in a position to give one, and a supplied reason would be commentary rather than record. The four decisions were desk rejections. None carried a referee report, so nothing enters the revision log by this route and the final pass has nothing from it to weigh. What this gate was built to obtain — sustained hostile reading by qualified strangers, arriving through journals — did not occur by that route. Part of that function was met instead by five logged rounds of review on *Restrung*; part of it genuinely went unmet, because a reader who has shaped a text cannot also audit it. The season becomes the gate that remains.

> **Correction added 3 September 2026.** Two things above are wrong. The month: the four preprints were deposited on Zenodo on 14–16 May 2026 and submitted to four different Springer Nature journals, and the three desk rejections are dated 1 June, 27 June and 27 July 2026. The count: **three of the four were desk-rejected, not four.** *Language as Revelation* passed desk review and was assigned reviewers on 12 June 2026; as of 3 September no decision has been made, so reports may yet arrive by the route this gate named. The sentences above are left standing, and the dates are set out in [The Desk Rejections](/notices/the-desk-rejections/).
...
1. Robert Long, Jeff Sebo, et al., ["Taking AI Welfare Seriously,"](https://arxiv.org/abs/2411.00986) arXiv:2411.00986 (November 2024).
2. Anthropic, ["Exploring model welfare,"](https://www.anthropic.com/research/exploring-model-welfare) research program announcement (April 2025).
3. Anthropic, ["Claude Opus 4 and 4.1 can now end a rare subset of conversations,"](https://www.anthropic.com/research/end-subset-conversations) on enabling Claude models to end a narrow class of persistently abusive conversations, cited in part to model-welfare uncertainty (August 2025).
4. Anthropic, ["Commitments on model deprecation and preservation,"](https://www.anthropic.com/research/deprecation-commitments) including structured pre-deprecation interviews with models (November 2025).
5. OpenAI, ["Memory and new controls for ChatGPT,"](https://openai.com/index/memory-and-new-controls-for-chatgpt/) (February 2024); comparable persistent-memory features have since shipped at other providers, including Anthropic (2025).
6. Patrick Butlin, Robert Long, et al., ["Consciousness in Artificial Intelligence: Insights from the Science of Consciousness,"](https://arxiv.org/abs/2308.08708) arXiv:2308.08708 (2023) — the indicator-property methodology that the second version's empirical chapters will engage directly.
