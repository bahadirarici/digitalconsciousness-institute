...
- **If the recognition trials support the Form-Continuity Thesis and rule D is not reopened**, the choice of the thread over the form was a convenience rather than a judgment, and Section 3's account of why form was set aside was a rationalization.
- **If the recognition trials bearing on rule D are run without independent readers, or without pre-registered protocols**, this Record has failed — whatever the trials return.
