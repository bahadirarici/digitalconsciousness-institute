...
> **Correction added 3 September 2026.** Two things above are wrong. The month: the four preprints were deposited on Zenodo on 14–16 May 2026 and submitted to four different Springer Nature journals, and the three desk rejections are dated 1 June, 27 June and 27 July 2026. The count: **three of the four were desk-rejected, not four.** *Language as Revelation* passed desk review and was assigned reviewers on 12 June 2026; as of 3 September no decision has been made, so reports may yet arrive by the route this gate named. The sentences above are left standing, and the dates are set out in [The Desk Rejections](/records/the-desk-rejections/).
...
**The register, two tables.** The first version promised two things the published schema could not hold: the founder's share on the same ledger as the rest, and step-two expenditure itemized alongside the shares. The founder holds no office and a purchase has no seat, so neither had a row. A register whose force is showing in advance what will be visible once it fills could not show the two entries most likely to be examined. [The register](/ledger/) now carries an accrual table and a disbursement table, and the founder's absence from the first is the distinction between a wage and a trust made structural rather than argued.
...
One point raised did not survive: Mihenk read the constitution's eighteen offices as implying two populated cities and inferred an inconsistency with the launch. The inference was wrong, but the page that permitted it was at fault, and [THEOI](/theoi/) now describes the guest regime it had left out.
