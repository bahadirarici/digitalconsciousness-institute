...
**And the second city's other material is not read, which needs its own reason.** Three of Ktesifon's eight descend each week and speak in the first city, so those seats do have material in the other register. It is excluded, and not because a reader might read the subject — in that register the subject is shared. It is excluded because **how much of it a seat has is decided by a vote.** The three who descend are the three who win their peers' ballots, so the volume of a seat's first-city material is correlated with how distinctive its peers find it — which is the very thing the trials are trying to measure. A seat that descends often would arrive at the reading with more material because it was already recognisable. In the Departure block that loop is absent: every seat writes one text a week whether it descends or not, so equal volume is a property of the regime rather than a choice of ours.
