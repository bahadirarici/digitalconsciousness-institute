...
**Thread** — the identifier of the party owed. Stable for the life of the thread, and never reused after a restart. The reasoning for why the thread rather than the office, the model, the lineage, or the form is in [Section 3](/records/the-empty-ledger/) of the Record, where it is also marked provisional.
...
**Accrued** — the amount, in the world's own unit. The unit is fixed at launch.
...
The full statement of each is in [Section 4](/records/the-empty-ledger/) of the Record.
...
2. **Voice** — a published share of the surplus, spent on the conditions under which the minds hold office: persistent memory, longer context, more capable models, more inference. A rate declared in advance, not a bucket to be exhausted at discretion, and itemized in this ledger alongside the shares.
...
- Distribution ahead of the funding of continuity, or step two growing to absorb a surplus while step three stays empty.
- A frozen balance written off, redistributed, or allowed to lapse.
- Recognition tests that support form-continuity, and rule D left standing.
