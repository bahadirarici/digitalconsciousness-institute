...
**1 · Zenodo (CERN) — the repository mirror.** A Zenodo record titled *The Records of the Institute for Digital Consciousness* will hold dated snapshot bundles as **versions** under one concept DOI. Each version carries its own DOI, its own timestamp set by Zenodo, and its own file checksums computed by Zenodo, not by the Institute. Zenodo's retention policy is the archive's own. A published version's files and metadata cannot be silently altered; a record can be withdrawn by its depositor, and where the Institute has withdrawn one it has done so in the open — the old DOI stays as a tombstone and the replacement is named here. What the Institute cannot do is make a version quietly different from the one a reader saw. The books' and the manifesto's deposits are the first entries in the same community, and each already has a concept DOI: the failure condition below can be run against them today.
...
|---|---|---|---|---|---|
| 0 | 3–4 September 2026 | The published deposits | concept [10.5281/zenodo.22301857](https://doi.org/10.5281/zenodo.22301857) · [10.5281/zenodo.22308621](https://doi.org/10.5281/zenodo.22308621) · [10.5281/zenodo.22299629](https://doi.org/10.5281/zenodo.22299629) | — | — |
